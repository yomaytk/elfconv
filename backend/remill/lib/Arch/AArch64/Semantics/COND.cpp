...
DEF_COND_ISEL(CSEL_32_CONDSEL, CSEL, R32, R32)  // CSEL  <Wd>, <Wn>, <Wm>, <cond>
DEF_COND_ISEL(CSEL_64_CONDSEL, CSEL, R64, R64)  // CSEL  <Xd>, <Xn>, <Xm>, <cond>

DEF_COND_ISEL(FCSEL_D_FLOATSEL, FCSEL, RF64, Rf64)  // FCSEL  <Dd>, <Dn>, <Dm>, <cond>
...
DEF_COND_ISEL(CCMP_32_CONDCMP_IMM, CCMP, R32, I32)  // CCMP  <Wn>, #<imm>, #<nzcv>, <cond>
DEF_COND_ISEL(CCMP_64_CONDCMP_IMM, CCMP, R64, I64)  // CCMP  <Xn>, #<imm>, #<nzcv>, <cond>

DEF_COND_ISEL(CCMP_32_CONDCMP_REG, CCMP, R32, R32)  // CCMP  <Wn>, <Wm>, #<nzcv>, <cond>
DEF_COND_ISEL(CCMP_64_CONDCMP_REG, CCMP, R64, R64)  // CCMP  <Xn>, <Xm>, #<nzcv>, <cond>

DEF_COND_ISEL(CCMN_32_CONDCMP_IMM, CCMN, R32, I32)  // CCMN  <Wn>, #<imm>, #<nzcv>, <cond>
DEF_COND_ISEL(CCMN_64_CONDCMP_IMM, CCMN, R64, I64)  // CCMN  <Xn>, #<imm>, #<nzcv>, <cond>
