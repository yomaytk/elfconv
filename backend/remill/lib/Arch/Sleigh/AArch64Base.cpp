...
#define SUB_REG(name, access, type, parent_reg_name) \
  ...
  REG(V0, simd.v[0], u8v16);
  REG(V1, simd.v[1], u8v16);
  REG(V2, simd.v[2], u8v16);
  REG(V3, simd.v[3], u8v16);
  REG(V4, simd.v[4], u8v16);
  REG(V5, simd.v[5], u8v16);
  REG(V6, simd.v[6], u8v16);
  REG(V7, simd.v[7], u8v16);
  REG(V8, simd.v[8], u8v16);
  REG(V9, simd.v[9], u8v16);
  REG(V10, simd.v[10], u8v16);
  REG(V11, simd.v[11], u8v16);
  REG(V12, simd.v[12], u8v16);
  REG(V13, simd.v[13], u8v16);
  REG(V14, simd.v[14], u8v16);
  REG(V15, simd.v[15], u8v16);
  REG(V16, simd.v[16], u8v16);
  REG(V17, simd.v[17], u8v16);
  REG(V18, simd.v[18], u8v16);
  REG(V19, simd.v[19], u8v16);
  REG(V20, simd.v[20], u8v16);
  REG(V21, simd.v[21], u8v16);
  REG(V22, simd.v[22], u8v16);
  REG(V23, simd.v[23], u8v16);
  REG(V24, simd.v[24], u8v16);
  REG(V25, simd.v[25], u8v16);
  REG(V26, simd.v[26], u8v16);
  REG(V27, simd.v[27], u8v16);
  REG(V28, simd.v[28], u8v16);
  REG(V29, simd.v[29], u8v16);
  REG(V30, simd.v[30], u8v16);
  REG(V31, simd.v[31], u8v16);
