...
void printhelp();
void run_dhrystone(int duration, int num_threads, long num_loops, int delay);
void run_for_duration(int duration, long num_loops);
void Proc0(long numloops, boolean print_result);
