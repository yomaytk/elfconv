var Module = (() => {
  return (async function (moduleArg = {}) {
    ...
    function newProcess(path, isFork, sDataSrcP, sDataLen, mBytesSrcP, mBytesLen, parWorkerId) {
      ...
      if (isFork) {
        ...
        copySData = e => {
          let d = e["data"];
          console.log(`parworkerid: ${parWorkerId}`);
    ...
    function ___syscall_clone(sDataP, sDataPLen, mBytes, mBytesLen, parWorkerId) {
      try {
        newProcess(initProcessJsPath, true, sDataP, sDataPLen, mBytes, mBytesLen, parWorkerId);
